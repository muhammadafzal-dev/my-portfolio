      ...
      <Link href={role.link} target="_blank" className="flex gap-4 transition">
        ...
        <dl className="flex flex-auto flex-wrap gap-x-2">
          ...
          >
            ...
            {endDate && <span aria-hidden="true">—</span>}
...
function Resume() {
  let certification: Array<Role> = [
    {
      ...
      title: 'React Native',
      logo: courseLogo,
      link: 'https://www.coursera.org/account/accomplishments/certificate/Y3UD43EM8L6X',
      start: 'Sept 2023',
    },
    {
      company: 'Simplilearn',
      ...
      logo: simplyLearn,
      link: 'https://www.simplilearn.com/skillup-certificate-landing?token=eyJjb3Vyc2VfaWQiOiIxNzI1IiwiY2VydGlmaWNhdGVfdXJsIjoiaHR0cHM6XC9cL2NlcnRpZmljYXRlcy5zaW1wbGljZG4ubmV0XC9zaGFyZVwvdGh1bWJfNDEzMzc2Nl8xNjc1MTkxODQzLnBuZyIsInVzZXJuYW1lIjoiTXVoYW1tYWQgQWZ6YWwifQ%3D%3D&utm_source=shared-certificate&utm_medium=lms&utm_campaign=shared-certificate-promotion&referrer=https%3A%2F%2Flms.simplilearn.com%2Fcourses%2F4215%2FReactJS-for-Beginners%2Fcertificate%2Fdownload-skillup&%24web_only=true&_branch_match_id=1139061688978390582&_branch_referrer=H4sIAAAAAAAAA8soKSkottLXL87MLcjJ1EssKNDLyczL1k%2FVd0w1Cg%2F1zssxKU8CAKeXMyclAAAA',
      start: '31 jan 2023',
    },
    // {
    //   company: 'Coursera',
    //   title: 'Create AWS EC2 Virtual Machine Using AWS',
    //   logo: courseLogo,
    //   link: 'https://www.coursera.org/account/accomplishments/certificate/ZZNBAHKQ34YV',
    //   start: '25 Sep 2023',
    // },
    // {
    //   company: 'Coursera',
    ...
    //   logo: courseLogo,
    //   link: 'https://www.coursera.org/account/accomplishments/certificate/FFWP8KM4L55R',
    //   start: '13 Sep 2023',
    // },
    // {
    //   company: 'Hacker Rank',
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href={`${process.env.NEXT_PUBLIC_SITE_URL}afzal_resume.pdf`}
        target="_blank"
        variant="secondary"
